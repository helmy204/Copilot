---
name: breakdown-test-azure
description: 'Test Planning and Quality Assurance prompt that generates comprehensive test strategies, task breakdown, and quality validation plans for Azure DevOps projects.'
---
...
4. **Azure DevOps Project Plan**: `/docs/ways-of-work/plan/{epic-name}/{feature-name}/project-plan.md`
...
2. **Test Work Items Checklist**: `/docs/ways-of-work/plan/{epic-name}/{feature-name}/test-work-items-checklist.md`
...
- **Azure Pipelines Integration**: Continuous testing pipeline integration via Azure Pipelines

#### 5. Azure DevOps Work Item Types

Map test activities to the following Azure DevOps work item types:

- **Test Plan**: Top-level container for an entire test effort (maps to Test Strategy)
- **Test Suite**: Logical grouping of test cases within a Test Plan (by feature, risk, or type)
- **Test Case**: Individual test scenario with steps, expected results, and acceptance criteria
- **Task**: Implementation and setup work items for test infrastructure and automation
- **User Story**: Stories under test — linked from test cases as the item being validated
- **Bug**: Defect work items raised from failed test cases, linked to Test Cases and User Stories

### Test Work Items Checklist

#### Test Level Work Items Creation

- [ ] **Test Plan Work Item**: Overall testing approach and quality validation plan
- [ ] **Unit Test Task Work Items**: Component-level testing for each implementation task
- [ ] **Integration Test Case Work Items**: Interface and interaction testing between components
- [ ] **End-to-End Test Case Work Items**: Complete user workflow validation using Playwright
- [ ] **Performance Test Task Work Items**: Non-functional requirement validation
- [ ] **Security Test Task Work Items**: Security requirement and vulnerability testing
- [ ] **Accessibility Test Case Work Items**: WCAG compliance and inclusive design validation
- [ ] **Regression Test Suite Work Items**: Change impact and existing functionality preservation
...
#### Azure DevOps Work Item Quality Standards

- [ ] **Template Compliance**: All test work items follow standardized Azure DevOps templates
- [ ] **Required Field Completion**: Mandatory fields (Title, State, Area Path, Iteration, Priority, Story Points) populated with accurate information
- [ ] **Tag Consistency**: Standardized tagging across all test work items
- [ ] **Priority Assignment**: Risk-based priority assignment using ADO priority scale (1=Critical, 2=High, 3=Medium, 4=Low)
- [ ] **Value Assessment**: Business value and quality impact assessment
- [ ] **Linked Work Items**: All test cases linked to their parent User Story or Feature

#### Tagging and Prioritization Standards

- [ ] **Test Type Tags**: `unit-test`, `integration-test`, `e2e-test`, `performance-test`, `security-test`
- [ ] **Quality Tags**: `quality-gate`, `iso25010`, `istqb-technique`, `risk-based`
- [ ] **Priority Tags**: `test-critical`, `test-high`, `test-medium`, `test-low`
- [ ] **Component Tags**: `frontend-test`, `backend-test`, `api-test`, `database-test`
- [ ] **Area Path Assignment**: Work items assigned to the correct Area Path for team routing
- [ ] **Iteration Path Assignment**: Work items assigned to the correct Sprint/Iteration
...
## Azure DevOps Work Item Templates for Testing

> Work items are created in Azure DevOps Boards. Each template below maps to a specific Azure DevOps work item type. Use **Test Plans** for Test Strategy, **Test Cases** for individual scenarios, **Tasks** for implementation work, and **Bugs** for defects.

### Test Plan Work Item Template

```markdown
# Test Plan: {Feature Name}

<!-- Azure DevOps Work Item Type: Test Plan -->
...
- **Assigned To**: {QA Lead}
- **Story Points**: 2-3
- **Tags**: test-strategy; istqb; iso25010; quality-gates
...
## Linked Work Items
- Parent Feature: #{feature-work-item-id}
- Related User Stories: #{story-id-1}, #{story-id-2}
```

### Playwright Test Implementation Work Item Template

```markdown
# Playwright Tests: {Story/Component Name}

<!-- Azure DevOps Work Item Type: Test Case (for individual scenarios) + Task (for automation implementation) -->

## Work Item Fields
- **Type**: Task (automation implementation) / Test Case (individual scenario)
- **Area Path**: {Project}\{Team Area}
- **Iteration Path**: {Project}\{Sprint}
- **Priority**: {1-Critical / 2-High / 3-Medium / 4-Low}
- **Assigned To**: {SDET / QA Engineer}
- **Story Points**: 2-5
- **Tags**: playwright; e2e-test; quality-validation
- **Parent**: #{user-story-work-item-id}
...
### Quality Assurance Work Item Template

```markdown
# Quality Assurance: {Feature Name}

<!-- Azure DevOps Work Item Type: Task (QA validation gate task linked to Feature) -->
...
- **Assigned To**: {QA Lead}
- **Story Points**: 3-5
- **Tags**: quality-assurance; iso25010; quality-gates
...
- [ ] No critical/high severity Bugs in Active state
- [ ] Performance benchmarks met
- [ ] Security validation passed
- [ ] Azure Test Plans run completed and results published
...
- [ ] Open Bugs: 0 Priority 1 or 2 Bugs at release

## Linked Work Items
- Parent Feature: #{feature-work-item-id}
- Linked Test Plan: #{test-plan-work-item-id}
- Open Bugs: #{bug-id-1}, #{bug-id-2}
...
- **Documentation Completeness**: 100% test work items have complete template information

---
name: breakdown-test-jira
description: 'Test Planning and Quality Assurance prompt that generates comprehensive test strategies, task breakdowns, and quality validation plans for Jira projects.'
---
...
4. **Jira Project Plan**: `/docs/ways-of-work/plan/{epic-name}/{feature-name}/project-plan.md`
...
2. **Test Tickets Checklist**: `/docs/ways-of-work/plan/{epic-name}/{feature-name}/test-tickets-checklist.md`
...
### Test Tickets Checklist

#### Test Level Ticket Creation

- [ ] **Test Strategy Jira Ticket**: Overall testing approach and quality validation plan
- [ ] **Unit Test Jira Tickets**: Component-level testing for each implementation task
- [ ] **Integration Test Jira Tickets**: Interface and interaction testing between components
- [ ] **End-to-End Test Jira Tickets**: Complete user workflow validation using Playwright
- [ ] **Performance Test Jira Tickets**: Non-functional requirement validation
- [ ] **Security Test Jira Tickets**: Security requirement and vulnerability testing
- [ ] **Accessibility Test Jira Tickets**: WCAG compliance and inclusive design validation
- [ ] **Regression Test Jira Tickets**: Change impact and existing functionality preservation
...
- [ ] **Implementation Dependencies**: Tests blocked by specific Jira ticket/task completion
...
- [ ] **Template Compliance**: All test tickets follow standardized templates
- [ ] **Required Field Completion**: Mandatory Jira fields populated with accurate information
- [ ] **Workflow State Validity**: Ticket statuses follow approved workflow transitions
- [ ] **Label Consistency**: Standardized labels across all test work items
...
- [ ] **Component Labels**: `frontend-test`, `backend-test`, `api-test`, `database-test`, `infrastructure-test`
- [ ] **Issue Types**: `Epic`, `Story`, `Task`, `Sub-task`, `Bug`, `Test` (based on project scheme)
- [ ] **Required Jira Fields**: `Summary`, `Description`, `Issue Type`, `Priority`, `Story Points`, `Epic Link`/`Parent`, `Sprint`, `Components`, `Labels`
...
## Jira Ticket Templates for Testing

### Test Strategy Ticket Template
...
## Jira Metadata
- Project Key: {PROJECT}
- Issue Type: Task (or Test Strategy custom type)
...
### Playwright Test Implementation Ticket Template
...
## Jira Metadata
- Project Key: {PROJECT}
- Issue Type: Test (or Task)
- Parent: {STORY-456}
- Priority: Medium
- Story Points: 2-5
- Labels: playwright, e2e-test, quality-validation
- Components: frontend-test, qa-automation
- Sprint: {Sprint Name}
...
### Quality Assurance Ticket Template
...
## Jira Metadata
- Project Key: {PROJECT}
- Issue Type: Task (or QA Validation custom type)
- Parent Epic: {EPIC-123}
- Priority: High
- Story Points: 3-5
- Labels: quality-assurance, iso25010, quality-gates
- Components: qa, security-test, performance-test
- Sprint: {Sprint Name}
...
- **Documentation Completeness**: 100% test tickets have complete Jira fields and template information
